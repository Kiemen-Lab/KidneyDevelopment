...
pth='\\Lucie Dequiedt\human fetal kidney\Annotate\multispecies\';
% location of 8-bit tif images corresponding to annotated files
pthim='\\Lucie Dequiedt\human fetal kidney\Annotate\multispecies\10x\'; 
% location of annotations for model testing
pthtest=['\\Lucie Dequiedt\human fetal kidney\Annotate\multispecies\testing\'];

% date of model training
nm='11_08_2024_combinedECM';
...
%% test model
pthtestim = '\\Lucie Dequiedt\human fetal kidney\Annotate\multispecies\testing\10x\';
