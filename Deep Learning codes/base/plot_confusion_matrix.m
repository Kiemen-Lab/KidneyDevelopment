function plot_confusion_matrix(D,classNames,pthDL)
...
if nargin==0
    ...
    classNames=["islets" "ducts" "vasculature" "fat" "acini" "collagen" "whitespace" "panin"];
end
...
if exist('pthDL','var')
    h=gcf;
    savefig(h,[pthDL,'confusion_matrix.fig']);
    print(h,[pthDL,'confusion_matrix'],'-djpeg','-r300');
end
