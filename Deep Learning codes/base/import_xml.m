function [xyout,reduce_annotations]=import_xml(filename,xmlfile,dm,ra)
...
% datafile.  If not, load them for all images and save them there.
    ...
    disp('    1. of 4. Importing annotation data from xml file')
    
    tic;stt=xml2struct2(xmlfile);
    ...
    %tic;xyout2=load_xml_coords(xmlfile);toc;
end
