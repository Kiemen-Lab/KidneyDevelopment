...
J = imread("\\Lucie Dequiedt\Kidney Project\Data for paper\Figure 2\early\mouse\LD_MM11_chop_0503_meta.tif");
mas = imread("\\Lucie Dequiedt\Kidney Project\Data for paper\Figure 2\early\mouse\LD_MM11_chop_0503_urinary.tif");
mas = double(mas);
mas=mas==1;mas=imfill(mas,'holes');mas = imerode(mas,strel('disk',1));
J = double(J).*mas;J(J==0) =5; 
ds=1;
cmap = [255 215 155;135 76 57;193 174 167;246 235 250;255 255 255];
