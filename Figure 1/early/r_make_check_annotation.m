...
J = imread("\\Lucie Dequiedt\Kidney Project\Data for paper\Figure 2\early\mouse\LD_MM11_chop_0503_urinary.tif");

J = double(J);J(J==0)=2;
ds=1;
cmap = [255 215 155;255 255 255;255 255 255;97 25 63;246 126 125];
